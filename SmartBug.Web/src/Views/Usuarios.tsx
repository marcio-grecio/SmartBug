...
const exportToPDF = () => {
  ...
  doc.autoTable({
    ...
    body: bodyData,
    // styles: { fillColor: [31, 41, 55] }, // bg-gray-800
    // headStyles: { fillColor: [31, 41, 55], textColor: [255, 255, 255] }, // text-white
  });
  ...
  return (
    <section className="mi-content rounded-md bg-[#ffffff] hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white text-center">
      <div className="mi-card" style={{ height: '89vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      ...
      {/* <div className="input-group mb-4">
        ...
        <button
          onClick={exportToPDF}
          className="ml-2 bg-green-500 text-white rounded-md px-4 py-2"
        >
          Export to PDF
        </button>
      </div> */}
            ...
            {users.map((packageItem, key) => (
              <tr key={key}>
                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                  ...
                  <p className="text-sm">${packageItem.nome}</p>
                </td>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <p
                    className={`inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium ${
                      packageItem.nome === 'Paid'
                        ? 'bg-success text-success'
                        : packageItem.nome === 'Unpaid'
